...
void Init_base()
{
	...
	// alignment periods
	anal.alignment_t0 = 72846;			// beginning of the first time-slice
	anal.alignment_ts = 73835 - 72846;	// time-slice in s
}
...
void Init_45t_56b()
{
	...
	anal.cut5_a = -0.134; anal.cut5_c = -0.117; anal.cut5_si = 0.04;
